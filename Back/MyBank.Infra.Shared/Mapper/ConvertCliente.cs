...
namespace MyBank.Infra.Shared.Mapper
{
    public static class ConvertCliente
    {
        ...
        public static ClienteModel ConvertToModel(this Cliente entity) => new ClienteModel(entity.Id, entity.Nome, entity.CPF.ToString(), entity.DataNascimento, entity.Conta);
